...
Our [naming standard v2.0](/guides/naming-standard) follows the format developed by the [Colorado Mesh](https://github.com/Colorado-Mesh/docs/blob/master/MeshCore/standards/naming/v2.1.md) community and used by the [Colorado Mesh utilities site](https://github.com/Colorado-Mesh/meshcore-utilities-site):
...
Questions? Join our [Discord](https://discord.gg/Tuuv9hGPnX). We're always happy to help with repeater placement, configuration, and getting your node named and on the mesh.
